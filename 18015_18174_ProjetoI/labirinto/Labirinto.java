...
public class Labirinto
{
	public static void main(String[] args)
	{
		try
		{
			...
			//leitura do arquivo texto, atribui��o dos valores da matriz
			...
			do
			{
				...
				if (!fila.isVazia()) //h� lugar para ir, modo progressivo
				{
					System.out.println("\nModo progressivo");
					...
					if (matriz[lPasso][cPasso] == 'S') //achou sa�da
					{
						System.out.println("\n\nLabirinto resolvido.");
						acabou = true;
					...
					else //não é a saída, é só um espaço em branco. Tem que dar passo
					{
				...
				else //não háa lugar para ir, modo regressivo
				{
